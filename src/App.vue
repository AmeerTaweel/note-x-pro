  ...
  <div id="app" class="h-100 d-flex flex-column">
    ...
    <footer class="footer bg-light p-3">
      <span>
        ...
        Developed by <strong>Ameer Taweel</strong> using <a href="https://vuejs.org/" target="_blank">Vue.js</a> and <a href="https://getbootstrap.com/" target="_blank">Bootstrap</a>.
      </span>
    </footer>  
  </div>
</template>
