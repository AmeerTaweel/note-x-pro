<template>
  <div id="app" class="h-100 d-flex flex-column">
    ...
    <footer class="footer bg-light p-3 border-top border-secondary">
      <span>
        Developed by <strong>Ameer Taweel</strong> using <a href="https://vuejs.org/" target="_blank">Vue.js</a> and <a href="https://getbootstrap.com/" target="_blank">Bootstrap</a>.<br/>
        ...
        <a href="https://ps.linkedin.com/in/ameer-taweel" target="_blank" class="badge badge-primary my-2">
          <svg class="size24" viewBox="0 0 24 24">
